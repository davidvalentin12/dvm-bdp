...
export interface IScapholdUserRegister {
  username: string;
  email: string;
  password: string;
}
export interface IScapholdUserLogin {
  username: string;
  password: string;
}
...
export class AuthService {
  ...
  login(user: IScapholdUserLogin): Promise<ApolloCurrentResult<IScapholdUser>> {
  ...
  register(user: IScapholdUserRegister): Promise<ApolloCurrentResult<IScapholdUser>> {
    return this.client.getClient().mutate({
      mutation: gql`
